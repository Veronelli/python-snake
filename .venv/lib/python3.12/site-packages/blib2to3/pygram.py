...
def initialize(
    ...
    assert (
        "print"
        not in python_grammar.keywords
    )
    assert (
        "exec"
        not in python_grammar.keywords
    ...
    soft_keywords = (
        python_grammar.soft_keywords.copy()
    )
    ...
    python_grammar_async_keywords.async_keywords = (
        True
    )
    python_grammar_async_keywords.version = (
        3,
        7,
    )
    ...
    # Python 3.10+
    python_grammar_soft_keywords = (
        python_grammar_async_keywords.copy()
    )
    python_grammar_soft_keywords.soft_keywords = (
        soft_keywords
    )
    python_grammar_soft_keywords.version = (
        3,
        10,
    )
