...
if TYPE_CHECKING:
    from blib2to3.pgen2.driver import (
        TokenProxy,
    )
...
class Recorder:
    def __init__(
        ...
        self.context = (
            context  # not really matter
        )

        self._dead_ilabels: set[int] = set()
        self._start_point = self.parser.stack
        self._points = {
            ilabel: stack_copy(self._start_point)
    ...
    def ilabels(
        ...
        return self._dead_ilabels.symmetric_difference(
            self._ilabels
        )
    ...
    def switch_to(
        ...
        with self.backtrack():
            self.parser.stack = self._points[
                ilabel
            ]
            try:
                yield
