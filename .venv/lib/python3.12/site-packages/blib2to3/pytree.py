...
class Base:
    ...
    def next_sibling(
        ...
        return self.parent.next_sibling_map[
            id(self)
        ]
    ...
    def prev_sibling(
        ...
        return self.parent.prev_sibling_map[
            id(self)
        ]
...
class Node(Base):
    ...
    def invalidate_sibling_maps(
        self,
    ) -> None:
        self.prev_sibling_map: Optional[
            dict[
                int,
                Optional[
                    NL
        ...
        self.next_sibling_map: Optional[
            dict[
                int,
                Optional[
                    NL
...
class Leaf(Base):
    ...
    column: int = (
        0  # Column where this token starts in the input
    )
    ...
    # converted code.
    fmt_pass_converted_first_leaf: Optional[
        "Leaf"
    ] = None
    ...
    def generate_matches(
        ...
        if (
            ...
            for (
                c,
                r,
            ) in self.content.generate_matches(
                nodes
            ):
                return
            yield 0, {}
