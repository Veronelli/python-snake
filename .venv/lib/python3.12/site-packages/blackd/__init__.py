...
async def handle(
    ...
    try:
        if (
            ...
            return web.Response(
                status=501,
                text="This server only supports protocol version 1",
            )
        ...
        logging.exception(
            "Exception during handling a request"
        )
        return web.Response(
            status=500,
            headers=headers,
