...
def _parse_specifier(
    ...
    with tokenizer.enclosing_tokens(
        ...
        parsed_specifiers = _parse_version_many(
            tokenizer
        )
        tokenizer.consume(
            "WS"
