...
_multiline_whitespace = make_regex(
    r"\s*",
    extra_flags=re.MULTILINE,
)
_whitespace = make_regex(
    r"[^\S\r\n]*"
)
_export = make_regex(
    r"(?:export[^\S\r\n]+)?"
...
_unquoted_key = make_regex(
    r"([^=\#\s]+)"
)
_equal_sign = make_regex(
    r"(=[^\S\r\n]*)"
)
...
class Reader:
    ...
    def get_marked(
        ...
        return Original(
            string=self.string[
                self.mark.chars : self.position.chars
            ],
            line=self.mark.line,
        )
    ...
    def peek(
        ...
        return self.string[
            self.position.chars : self.position.chars
            + count
        ]
