...
class UsageError(
    ...
    def show(
        ...
        if (
            self.ctx
            is not None
            and self.ctx.command.get_help_option(
                self.ctx
            )
            is not None
        ):
            hint = _(
                ...
                option=self.ctx.help_option_names[
                    0
                ],
            )
            hint = (
