...
try:
    ...
    def get_buffer(
        ...
        try:
            ...
            return buffer_type.from_address(
                buf.buf
            )
        finally:
            PyBuffer_Release(
...
class ConsoleStream:
    def __init__(
        self,
        text_stream: t.TextIO,
        byte_stream: t.BinaryIO,
    ) -> None:
        self._text_stream = (
            text_stream
        )
    ...
    def write(
        ...
        if isinstance(
            ...
            return self._text_stream.write(
                x
            )
        try:
            self.flush()
