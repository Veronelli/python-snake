...
class ParamType:
    ...
    def to_info_dict(
        ...
        param_type = param_type.partition(
            "ParameterType"
        )[
            0
        ]
...
class Choice(ParamType):
    ...
    def convert(
        ...
        if (
            ...
            normed_value = ctx.token_normalize_func(
                value
            )
            normed_choices = {
        ...
        if not is_dash:
            ...
            try:
                ...
                if (
                    ...
                    return self.coerce_path_result(
                        rv
                    )
                self.fail(
                    _(
