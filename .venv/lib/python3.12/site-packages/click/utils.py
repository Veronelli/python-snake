...
def echo(
    ...
    if isinstance(
        ...
        binary_file = _find_binary_writer(
            file
        )
...
def get_binary_stream(
    ...
    if opener is None:
        raise TypeError(
            f"Unknown standard stream '{name}'"
        )
    return opener()
