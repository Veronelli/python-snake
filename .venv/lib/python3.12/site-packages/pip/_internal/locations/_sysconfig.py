...
def _should_use_osx_framework_prefix() -> (
    bool
):
...
def get_scheme(
    ...
    """
    if user and prefix:
        raise InvalidSchemeCombination(
            "--user",
            "--prefix",
        )
    if home and prefix:
