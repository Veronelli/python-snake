    ...
    if (
        ...
        if should_list_installed:
            ...
            installed = [
                ...
                if dist.canonical_name.startswith(
                    lc
                )
                and dist.canonical_name
                not in cwords[
                    1:
                ]
            ]
        ...
        flattened_opts = chain.from_iterable(
            opts
        )
