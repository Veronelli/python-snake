...
def get_configuration_files() -> (
    ...
    global_config_files = [
        ...
        for path in appdirs.site_config_dirs(
            "pip"
        )
    ]
...
class Configuration:
    ...
    def get_file_to_edit(
        ...
        try:
            return self._get_parser_to_modify()[
                0
            ]
        except IndexError:
            return None
    ...
    def iter_config_files(
        ...
        yield kinds.GLOBAL, config_files[
            kinds.GLOBAL
        ]
        ...
        if should_load_user_config:
            ...
            yield kinds.USER, config_files[
                kinds.USER
            ]

        # virtualenv config
        yield kinds.SITE, config_files[
            kinds.SITE
        ]
