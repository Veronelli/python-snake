...
from pip._vendor.rich.markup import (
    escape,
)
from pip._vendor.rich.text import (
    Text,
)
    ...
    def from_config(
        ...
        try:
            ...
            for (
                ...
                cls._iter_externally_managed_error_keys()
            ):
...
class UninstallMissingRecord(
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            message=Text(
                f"Cannot uninstall {distribution}"
            ),
            context=(
