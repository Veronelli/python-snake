...
class BuildEnvironment:
    ...
    def __init__(
        ...
        for (
            ...
            self._bin_dirs.append(
                prefix.bin_dir
            )
            self._lib_dirs.extend(
                prefix.lib_dirs
            )
